...
import './smart-contract-number-property-view.scss';

const MAX_UINT32 = 4294967295;

interface SmartContractNumberPropertyViewProps {
...
interface SmartContractNumberPropertyViewState {
    value: number;
}

export default class SmartContractNumberPropertyView extends React.Component<SmartContractNumberPropertyViewProps, SmartContractNumberPropertyViewState> implements ISmartContractPropertyView {
